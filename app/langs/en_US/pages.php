...
$trans['categories.edit_articles_items'] = 'Items list';


$trans['categories.edit_item'] = 'Editeaza categorie';
$trans['categories.delete_item'] = 'Sterge categorie';

$trans['categories.items_count'] = '%s items';
$trans['categories.item_count'] = '%s item';
...
$trans['app_image.alt'] = 'Textul care va fi afisat in lispa pozei, de obicei acelasi cu titlul pozei: ';
$trans['app_image.title'] = 'Titlul pozei pentru SEO: ';
$trans['app_image.caption'] = 'Titlul Descrierii pozei. Va fi afisat peste poza ca un sticker alb cu text negru: ';
$trans['app_image.description'] = 'Descrierea pozei. Va fi afisata peste poza ca un sticker alb cu text negru : ';
