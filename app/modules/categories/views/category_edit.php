...
<table class="edit_table">
	...
	<tr>
		<td style="width: 200px;"><?php echo $trans['categories.is_separate']?> </td>
		<td>
			<input type="checkbox" name="chkDisplaySeparateStatus" id="chkDisplaySeparateStatus"  class="" value="" <?php echo $dataView->chkDisplaySeparateStatus?> />
		</td>
	</tr>
	<tr>
